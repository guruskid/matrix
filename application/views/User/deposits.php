 ...
 <?php
    ...
    <div class="row">
        ...
        <div class="text-center">
            <h1 class="text-center">Crypto Matrix :: Deposits and Active Plans</h1>
            <p>Note: <b>Make Sure to Send Proof of Payment within 48hrs of Actual Payment for Verification. <br /> If Deposit
                    is not made within 48hrs of Selecting a Plan, Your Account wil be Suspended</b></p>
        </div>
        <div class="row">
                    ...
                    <div class="box-body text-center">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $count = 1;
                                $plans = $this->db->get_where('activated_plans', array('user_encrypted_id' => $this->session->userdata('matrix_user_encrypted_id')))->result_array();
