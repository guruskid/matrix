...
<html>
  <head>
    ...
    <link href="<?php echo base_url() ?>assets/dashboard/plugins/datatables/dataTables.bootstrap.css" rel="stylesheet" type="text/css" />
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo $this->crud_model->get_image_url('admin', $this->session->userdata('matrix_admin_id')) ?>" class="user-image" alt="User Image"/>
                  <span class="hidden-xs"><?php echo $this->session->userdata('matrix_admin_username') ?></span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <?php echo $this->session->userdata('matrix_admin_username') ?>
