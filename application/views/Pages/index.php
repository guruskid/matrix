...
<div class="wrapper">
    ...
    <div id="main-slide" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <a class="left carousel-control" href="<?php echo APPPATH; ?>#main-slide" data-slide="prev">
            <span><i class="fa fa-angle-left"></i></span>
        </a>
        <a class="right carousel-control" href="<?php echo APPPATH; ?>#main-slide" data-slide="next">
