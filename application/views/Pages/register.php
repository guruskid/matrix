        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
            ...
            <div class="form-container">
                <div>
                    ...
                    <!-- Section Title Ends -->
                    <!-- Form Starts -->
                    <form action="<?php echo base_url('register/confirm_registration') ?>" method="post">
                        <!-- Input Field Starts -->
                        ...
                        <div class="form-group">
                            ...
                            <p class="text-center">already have an account ? <a href="<?php echo base_url(); ?>login">Login</a>
                        </div>
