        ...
        <div class="container">
            ...
            <div class="row about-content">
                ...
                <div class="col-sm-12 col-md-5 col-lg-6 text-center">
                    <img id="about-us" class="img-responsive img-about-us" src="<?php echo base_url(); ?>images/about-us.png" alt="about us">
                </div>
                <!-- Image Ends -->
                <!-- Content Starts -->
        ...
        <div class="container">
            ...
            <div class="row text-center facts-content">
                ...
                <div class="col-xs-12 buttons">
                    ...
                    <a class="btn btn-primary btn-register" href="<?php echo base_url(); ?>register">Register Now</a>
                </div>
            </div>
            <!-- Fact Badges Ends -->
        </div>
            ...
            <div class="row team-content team-members">
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    <div class="team-member">
                        ...
                        <img src="<?php echo base_url(); ?>images/team/member1.jpg" class="img-responsive" alt="team member">
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    <div class="team-member">
                        <!-- Team Member Picture Starts -->
                        <img src="<?php echo base_url(); ?>images/team/member2.jpg" class="img-responsive" alt="team member">
                        <!-- Team Member Picture Ends -->
                        <!-- Team Member Details Starts -->
                        <div class="team-member-caption social-icons">
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    ...
                    <div class="team-member">
                        <!-- Team Member Picture Starts -->
                        <img src="<?php echo base_url(); ?>images/team/member3.jpg" class="img-responsive" alt="team member">
                        <!-- Team Member Picture Ends -->
                        <!-- Team Member Details Starts -->
                        <div class="team-member-caption social-icons">
                            <h4>Emilia Bella</h4>
                ...
                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                    <div class="team-member">
                        <!-- Team Member Picture Starts -->
                        <img src="<?php echo base_url(); ?>images/team/member4.jpg" class="img-responsive" alt="team member">
                        <!-- Team Member Picture Ends -->
                        <!-- Team Member Details Starts -->
                        <div class="team-member-caption social-icons">
                            <h4>Antonio Conte</h4>
