                 ...
                 <div class="col-xs-12">
                     <div class="box">
                         <div class="box-header">
                             <h2 class="text-center">Crypto Matrix Withdrawal Users </h2>
                         </div><!-- /.box-header -->
                         <div class="box-body">
                             <table id="example1" class="table table-bordered table-striped">
                                 ...
                                 <tbody>
                                     <?php
                                        $count = 1;
                                        $users  = $this->db->get('members')->result_array();
                                        foreach ($users as $user) :
                                        ?>
                                         <tr>
                                             <td><?php echo $count++; ?></td>
                                             <td><a href="<?php echo base_url('admin/user_profile/'.$user['encrypted_id']) ?>"><?php echo $user['fullname'] ?></a></td>
                                             <td><?php echo $user['email'] ?></td>
                                             <td><?php echo $user['date_joined'] ?></td>
                                             <?php if ($user['account_status'] == 1) : ?>
                                                 <td class="text-center"><span class="badge bg-green">Account Active</span></td>
                                             <?php else : ?>
                                                 <td class="text-center"><span class="badge bg-red">Account Blocked</span></td>
                                             <?php endif; ?>
                                         </tr>
                                     <?php endforeach; ?>
                                 </tbody>
